...
def abrir_registro_ventas():
    ...
    def registrar_venta():
        ...
        # SI hay datos → mostrar ticket correctamente
...
# BOTONES PRINCIPALES
# -------------------------
btn_productos = ttk.Button(ventana, text="Registro de Productos", style="RojoNegro.TButton", command=abrir_registro_productos)
btn_productos.pack(pady=10)

btn_ventas = ttk.Button(ventana, text="Registro de Ventas", style="RojoNegro.TButton", command=abrir_registro_ventas)
btn_ventas.pack(pady=10)

btn_reportes = ttk.Button(ventana, text="Reportes", style="RojoNegro.TButton", command=abrir_reportes)
btn_reportes.pack(pady=10)

btn_acerca = ttk.Button(ventana, text="Acerca de", style="RojoNegro.TButton", command=abrir_acerca_de)
